...
<!-- PROJECT HEADER-->
![](./fvm-logo-horizontal-color-dark.png#gh-light-mode-only)
![](./fvm-logo-horizontal-color-light.png#gh-dark-mode-only)

<h3 align="center">FVM Docs</h3>
    <p align="center"> 
        This repository manages the documentation for the Filecoin Virtual Machine, along with the website build tools.
    <br />
    <a href="https://fvm.filecoin.io/docs"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="#">Staging preview</a> | <a href="#">Report Bug</a> | <a href="https://github.com/filecoin-project/fvm-docs/issues">Request Feature</a>
  </p>
</div>
...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `filecoin-project`, `fvm-docs`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/filecoin-project/fvm-docs.git
   ```
...
[license-shield]: https://img.shields.io/github/license/filecoin-project/fvm-docs.svg?style=for-the-badge
